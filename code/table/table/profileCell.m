...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        profileTopName = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, 320, 42)];
        ...
        profileBottomName = [[UILabel alloc]initWithFrame:CGRectMake(110, 148, 320, 40)];
        ...
        profileBottomName.font = [UIFont systemFontOfSize:15];
        customFont = [UIFont fontWithName:@"Aller-Light" size:profileBottomName.font.pointSize];
        [profileBottomName setFont:customFont];
        //[profileBottomName setCenter:self.center];
        [self.contentView addSubview:profileBottomName];
        
        profileLocation = [[UILabel alloc]initWithFrame:CGRectMake(110, 170, 320, 20)];
        [profileLocation setText:userLocation];
        [profileLocation setBackgroundColor:[UIColor colorWithRed:100/255.0 green:0/255.0 blue:100/255.0 alpha:0.0]];
        profileLocation.font = [UIFont systemFontOfSize:13];
        customFont = [UIFont fontWithName:@"Lato-Light" size:profileLocation.font.pointSize];
